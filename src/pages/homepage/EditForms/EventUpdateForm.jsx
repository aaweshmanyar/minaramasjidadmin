...
export default function CreateOrEditEvent() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setPublicationDate(
          data.eventDate ? new Date(data.eventDate).toISOString().slice(0, 10) : getCurrentDate()
        );
        setVenue(data.venue || "");
        setSelectedWriter(data.writers || "");
        ...
        setUrduTitle(data.urduTitle || "");
        setUrduDescription(data.urduDescription || "");

        setRomanTitle(data.romanUrduTitle || "");
        setRomanDescription(data.romanUrduDescription || "");

        setHindiTitle(data.hindiTitle || "");
  ...
  const handleImageUpload = (e) => {
    ...
    // hide server image once a new file is chosen
  ...
  /* ---------- Create / Update with upload progress ---------- */
  const submitEvent = async (publishFlag) => {
    ...
    try {
      ...
      formData.append("isPublished", publishFlag ? "true" : "false");
          ...
          <div className="mb-8 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                {isEdit ? "Update details and content." : "Details on the right, content below."}
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                >
                  {/* Priority: new preview > server image (edit) > empty state */}
                  {uploadedImageURL ? (
                    ...
                    <div className="relative inline-block">
                      ...
                      <div className="mt-3 text-xs text-gray-600">
                        (To replace, click here and choose a new file)
                      </div>
                    </div>
                  ) : (
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                >
                  ...
                  {languages.map((language) => (
                    <option key={language.id || language._id || language.language} value={language.language}>
                      {language.language}
                    </option>
                  ))}
                </select>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                >
                  ...
                  {writers.map((writer) => (
                    <option key={writer.id || writer._id || writer.name} value={writer.name}>
                      {writer.name}
                    </option>
                  ))}
                </select>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                >
                  ...
                  {translators.map((translator) => (
                    <option key={translator.id || translator._id || translator.name} value={translator.name}>
                      {translator.name}
                    </option>
                  ))}
                </select>
              ...
              {/* Publish toggle (only visible in edit to reflect current) */}
              {isEdit && (
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      This mirrors the two buttons below. Choosing “Update as Draft” or “Update & Publish” will set it automatically.
                    </p>
                  </div>
                </div>
              )}
